...
class Sweep(gr.sync_block):  
    """Sweep block to sweep gain and measure 4 quantities. Output is saved as two .npy files. 
        ...
        match self.state:
            case 0:
                if self.Sweep == True: #Log initial value
                    ...
                    print("\nRunning Sweep...")
                    self.message_port_pub(pmt.intern("out"), pmt.cons(pmt.intern("gain"),pmt.to_pmt(self.SwpVar)))
